...
if __name__ == '__main__':
    ...
    receivers = ['sudhakarmurugan5@gmail.com', '2001nirmalrajs@gmail.com', 'stebinfranco123@gmail.com']
    for receiver in receivers:
        mail = SendMail(sender, receiver)
        mail.add_subject('Election Results')
        mail.add_body('TN Election Results-2021')
        mail.add_attachment('election_results.csv')
        mail.add_attachment('vote_percentage.csv')
        mail.send()
